  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-left space-y-5 mb-6 text-[12px] md:text-[13px] text-gray-200 bubble-glass p-5 md:p-6 max-h-[60vh] overflow-y-auto border-white/10 relative z-20" data-lenis-prevent style={{ borderRadius: '12px' }}>
          <div>
